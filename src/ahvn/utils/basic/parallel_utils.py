...
class Parallelized:
    def __init__(self, func: Callable, args: Iterable[Dict[str, Any]] = None, num_threads: Optional[int] = None, desc: str = None):
        """\
        Initialize a parallelized task executor with progress tracking (tqdm).
    ...
    def __enter__(self):
        ...
        Usage:
            with Parallelized(func, args) as ptasks:
                ptasks.pbar.set_description("Processing tasks")
    ...
    def _handle_interrupt(self):
        ...
        self._pbar.write(f"Cancelled {cancelled} pending tasks.")
