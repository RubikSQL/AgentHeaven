...
toolspec_dict = {
    fib_tool.name: fib_tool,
    mul_tool.name: mul_tool,
    submit_tool.name: submit_tool,
}
...
agent = SubmitToolAgentSpec(prompt=p, tools=[fib_tool, mul_tool, submit_tool], llm_args={"preset": "chat"})
